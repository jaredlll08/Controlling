...
public class GuiNewKeyBindingList extends GuiKeyBindingList {
	...
	public GuiNewKeyBindingList(GuiNewControls controls, Minecraft mcIn) {
		...
		// this.listEntries = new GuiListExtended.IGuiListEntry[akeybinding.length +
		// KeyBinding.getKeybinds().size()];
		...
		for (final KeyBinding keybinding : akeybinding) {
			...
			final int j = mcIn.fontRendererObj
					.getStringWidth(I18n.format(keybinding.getKeyDescription(), new Object[0]));
	...
	public class KeyEntry implements GuiListExtended.IGuiListEntry {
		...
		private KeyEntry(KeyBinding name) {
			...
			this.btnChangeKeyBinding = new GuiButton(0, 0, 0, 95, 20,
					I18n.format(name.getKeyDescription(), new Object[0]));
